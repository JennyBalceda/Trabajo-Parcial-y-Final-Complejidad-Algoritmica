...
def PathFind(path):
  ...
  coordenada = ''
  for i in range(len(path)):
    aux2 = dataIntersections[int(path[i])]
    
    if aux2 != []:
      print(aux2)
      print(aux2[13])
      aux.append([float(aux2[11]), float(aux2[12])])
      aux.append([float(aux2[13]), float(aux2[14])])
...
#sourceIndex = intersectionList.index(['-12.0466783', '-77.0430483']) -12.0466783, -77.0430483
#targetIndex = intersectionList.index(['-12.0466949', '-77.042435']) -12.0466949, -77.042435
